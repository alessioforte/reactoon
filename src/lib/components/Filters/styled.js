...
export const Button = styled.div`
    ...
    color: ${props => props.value ? props.theme.colors.text : props.theme.colors.idle};
    padding: 0 10px;
    &:hover {
        opacity: 0.8;
    }
...
export const Option = styled.div`
    ...
    margin: 3px;
    background: ${props => props.isSelected ? props.theme.colors.primary : props.theme.colors.ground };
    color: ${props => props.isSelected ? props.theme.colors[getContrastYIQ(props.theme.colors.primary)] : props.theme.colors[getContrastYIQ(props.theme.colors.ground)]};
    border-radius: 3px;
    &:hover {
        color: ${props => props.isSelected ? props.theme.colors[getContrastYIQ(props.theme.colors.primary)] : props.theme.colors[getContrastYIQ(props.theme.colors.ground)]};
        cursor: pointer;
