...
import { Block, Button, Drop, List, Selected, Head, Placeholder, Icon, Control, Option, IsSelected } from './styled';
        ...
        return selected.map((item, i) => (
            <div key={`${item}-${i}`}>
                ...
                <div onClick={e => this.unselect(e, item)}>
                    <Delete size={8} color={theme.colors[getContrastYIQ(theme.colors.primary)]} margin='0 0 0 8px' />
                </div>
            </div>
        ));
    }
            ...
            <ThemeProvider theme={theme}>
                <Block ref={this.dropdown}>
                    ...
                    <Button onClick={this.show} isError={isError}>
                        ...
                        <Icon>
                            <Caret size={8} color={theme.colors[getContrastYIQ(theme.colors.background)]} />
                        </Icon>
                    </Button>
                    {visible && (
                                    ...
                                    this.options.map((item, i) => {
                                        ...
                                        return (
                                            <Option
                                                ...
                                                onClick={isSelected ? e => this.unselect(e, item) : e => this.select(e, item)}
                                            >
                                                {item.text}
                                            </Option>
                                        );
