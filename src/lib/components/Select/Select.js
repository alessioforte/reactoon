                        ...
                        visible && (
                            ...
                            >
                                ...
                                <List reverse={position.top ? true : false}>
                                    {
                                        text && <Null onClick={(e) => { this.select({ text: null, value: null }) }}>{ placeholder }</Null>
                                    }
                                    {
...
const Button = styled.div`
    ...
    color: ${props => props.value ? props.theme.colors[getContrastYIQ(props.theme.colors.background)] : props.theme.colors.ground};
    padding: 0 10px;
    &:hover {
