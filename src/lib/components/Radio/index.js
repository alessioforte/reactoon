...
const Selector = styled.div`
    ...
    /* border: 1px solid ${props => (props.active ? props.theme.colors.active : props.theme.colors.background)}; */
    ...
    & > div {
        ...
        height: 10px;
        border-radius: 50%;
        background: ${props => (props.active ? props.theme.colors.primary : props.theme.colors.ground)};
    }
`;
