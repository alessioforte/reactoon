...
class Transfer extends Component  {
    ...
    shiftTo(direction) {
        ...
        if (rightSelected.length === 1) {
            ...
            if (direction === 'up') index = (index + rightItems.length - 1) % rightItems.length
                ...
                <Box>
                    ...
                    <Buttons>
                        <Button
                            ...
                            onClick={() => leftSelected.length !== 0 ? this.moveTo('right') : null}
                        >
                            <Icon name='arrow right' />
                        </Button>
                        <Button
                            disabled={rightSelected.length === 0}
                            onClick={() => rightSelected.length !== 0 ? this.moveTo('left') : null}
                        >
